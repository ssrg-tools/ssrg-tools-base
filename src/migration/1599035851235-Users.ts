...
export class Users1599035851235 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TABLE `user_credentials` ' +
    ...
    await queryRunner.query('ALTER TABLE `users` CHANGE COLUMN `email` `email` VARCHAR(255) NULL COLLATE \'utf8mb4_unicode_ci\' AFTER `last_login`;');
