...
export class AddLeagueTracker1600327341595 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `league_tracker` ADD CONSTRAINT `FK_e0b3f9fcf35ff316a213c23d986` FOREIGN KEY (`divisionId`) REFERENCES `divisions`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT',
    );
    await queryRunner.query(
      'ALTER TABLE `league_tracker` ADD CONSTRAINT `FK_900818981d9eb49fd11fd70287c` FOREIGN KEY (`gameId`) REFERENCES `superstar_games`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT',
    );
  }
