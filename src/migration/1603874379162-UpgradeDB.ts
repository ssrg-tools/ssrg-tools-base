...
export class UpgradeDB1603874379162 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `superstar_games_populations` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `population` int UNSIGNED NOT NULL, `date` datetime NOT NULL, `gameId` int UNSIGNED NOT NULL, `guid` varchar(255) NOT NULL, INDEX `byDate` (`date`), UNIQUE INDEX `IDX_a9736ddd490a1621cb3854102b` (`guid`), PRIMARY KEY (`id`)) ENGINE=InnoDB');
    ...
    await queryRunner.query('ALTER TABLE `superstar_games` ADD `isSingleArtistGame` tinyint UNSIGNED NOT NULL DEFAULT 0');
    ...
    await queryRunner.query('ALTER TABLE `artists` ADD `group` varchar(255) NULL COMMENT \'to group e.g. the NCT units under NCT\'');
