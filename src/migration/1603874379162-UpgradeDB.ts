...
export class UpgradeDB1603874379162 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `league_tracker` ADD `profileId` int UNSIGNED NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `song_world_records` ADD `profileId` int UNSIGNED NULL',
    );
    await queryRunner.query('ALTER TABLE `users_logins` ADD `meta` json NULL');
    await queryRunner.query(
      'ALTER TABLE `superstar_games` ADD `dateReleased` date NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `superstar_games` ADD `hasPrism` tinyint UNSIGNED NOT NULL DEFAULT 0',
    );
    await queryRunner.query(
      'ALTER TABLE `superstar_games` ADD `isSingleArtistGame` tinyint UNSIGNED NOT NULL DEFAULT 0',
    );
    await queryRunner.query(
      "ALTER TABLE `superstar_games` ADD `xpSystem` varchar(255) NOT NULL DEFAULT 'common'",
    );
    ...
    await queryRunner.query(
      'ALTER TABLE `artists` ADD `imageId` varchar(255) NULL DEFAULT NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `artists` ADD `dateDebut` datetime NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `artists_members` ADD `dateBirthday` datetime NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `songs` ADD `swrStatHighscore` int UNSIGNED NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `songs` ADD `swrStatMin` int UNSIGNED NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `songs` ADD `swrStatMean` int UNSIGNED NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `songs` ADD `swrStatMedian` int UNSIGNED NULL',
    );

    await queryRunner.query(
      'CREATE INDEX `byDateDebut` ON `artists` (`dateDebut`)',
    );
    await queryRunner.query(
      'CREATE INDEX `byDateBirthday` ON `artists_members` (`dateBirthday`)',
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `player_profiles` DROP FOREIGN KEY `FK_887adb9d555b50e3909d713f30d`',
    );
    await queryRunner.query(
      'ALTER TABLE `player_profile_images` DROP FOREIGN KEY `FK_b88087eafab3747821520e852dc`',
    );
    await queryRunner.query(
      'ALTER TABLE `player_profile_nicknames` DROP FOREIGN KEY `FK_4c610a25fa7ee569d8ef1432b39`',
    );
    await queryRunner.query(
      'ALTER TABLE `league_tracker` DROP FOREIGN KEY `FK_c25b591527001a723e92df13d94`',
    );
    await queryRunner.query(
      'ALTER TABLE `song_world_records` DROP FOREIGN KEY `FK_23476a4ef9023592d8b960f643a`',
    );
    ...
    await queryRunner.query(
      'ALTER TABLE `artists_members` DROP COLUMN `dateBirthday`',
    );
    ...
    await queryRunner.query(
      'ALTER TABLE `superstar_games` DROP COLUMN `xpSystem`',
    );
    await queryRunner.query(
      'ALTER TABLE `superstar_games` DROP COLUMN `isSingleArtistGame`',
    );
    await queryRunner.query(
      'ALTER TABLE `superstar_games` DROP COLUMN `hasPrism`',
    );
    await queryRunner.query(
      'ALTER TABLE `superstar_games` DROP COLUMN `dateReleased`',
    );
    await queryRunner.query('ALTER TABLE `users_logins` DROP COLUMN `meta`');
    await queryRunner.query(
      'ALTER TABLE `song_world_records` DROP COLUMN `profileId`',
    );
    await queryRunner.query(
      'ALTER TABLE `league_tracker` DROP COLUMN `profileId`',
    );
    ...
    await queryRunner.query(
      'ALTER TABLE `songs` DROP COLUMN `swrStatHighscore`',
    );

    await queryRunner.query(
      'DROP INDEX `IDX_a9736ddd490a1621cb3854102b` ON `superstar_games_populations`',
    );
    await queryRunner.query(
      'DROP INDEX `byDate` ON `superstar_games_populations`',
    );
    await queryRunner.query('DROP TABLE `superstar_games_populations`');
    await queryRunner.query(
      'DROP INDEX `IDX_8ebc64a691c58259c1fe8c821c` ON `player_profiles`',
    );
    await queryRunner.query(
      'DROP INDEX `IDX_6e575941a0e824087375ecdb5f` ON `player_profiles`',
    );
    await queryRunner.query(
      'DROP INDEX `byDateRegistered` ON `player_profiles`',
    );
    await queryRunner.query(
      'DROP INDEX `byDateReportedRegistration` ON `player_profiles`',
    );
    await queryRunner.query(
      'DROP INDEX `byDateFirstObserved` ON `player_profiles`',
    );
    ...
    await queryRunner.query(
      'DROP INDEX `IDX_8e4c6332be5f542e7db3f14e14` ON `player_profile_images`',
    );
    ...
    await queryRunner.query(
      'DROP INDEX `IDX_71ab1e74608c872ee09af63317` ON `player_profile_nicknames`',
    );
    await queryRunner.query(
      'DROP INDEX `byDate` ON `player_profile_nicknames`',
    );
    await queryRunner.query(
      'DROP INDEX `byNickname` ON `player_profile_nicknames`',
    );
