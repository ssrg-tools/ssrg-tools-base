...
export class AddArtists1600345568347 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE `artists_members` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `artistId` int UNSIGNED NOT NULL, `name` varchar(255) NOT NULL, `memberOffset` tinyint UNSIGNED NOT NULL, `guid` varchar(255) NOT NULL, UNIQUE INDEX `IDX_cfcb0b72fa4ff195125caa885a` (`artistId`, `memberOffset`), UNIQUE INDEX `IDX_2611da3855f35b965103a1fc97` (`artistId`, `name`), UNIQUE INDEX `IDX_9db30a644f0db3919fd0c8dc29` (`guid`), PRIMARY KEY (`id`)) ENGINE=InnoDB');
    await queryRunner.query('CREATE TABLE `artists` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `cardCount` tinyint UNSIGNED NULL, `guid` varchar(255) NOT NULL, `gameId` int UNSIGNED NOT NULL, UNIQUE INDEX `IDX_70c3685e197743b963339d158c` (`name`), UNIQUE INDEX `IDX_502adb6bbe1506997cf6d1aeb1` (`guid`), PRIMARY KEY (`id`)) ENGINE=InnoDB');
