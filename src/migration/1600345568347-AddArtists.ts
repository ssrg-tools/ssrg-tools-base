...
export class AddArtists1600345568347 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `songs` ADD `artist_id` int UNSIGNED NULL',
    );
    await queryRunner.query(
      'ALTER TABLE `themes` ADD `artist_id` int UNSIGNED NULL',
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE `artists` DROP FOREIGN KEY `FK_2e2fda1dec4c9bc16704e9ff772`',
    );
    await queryRunner.query(
      'ALTER TABLE `themes` DROP FOREIGN KEY `FK_e4cb9c54007a543fca28c05cf93`',
    );
    await queryRunner.query(
      'ALTER TABLE `songs` DROP FOREIGN KEY `FK_999ba7dd3c94dd5f9649944a5c6`',
    );
    ...
    await queryRunner.query(
      'DROP INDEX `IDX_502adb6bbe1506997cf6d1aeb1` ON `artists`',
    );
    await queryRunner.query(
      'DROP INDEX `IDX_70c3685e197743b963339d158c` ON `artists`',
    );
    await queryRunner.query('DROP TABLE `artists`');
    await queryRunner.query(
      'DROP INDEX `IDX_9db30a644f0db3919fd0c8dc29` ON `artists_members`',
    );
    await queryRunner.query(
      'DROP INDEX `IDX_2611da3855f35b965103a1fc97` ON `artists_members`',
    );
    await queryRunner.query(
      'DROP INDEX `IDX_cfcb0b72fa4ff195125caa885a` ON `artists_members`',
    );
