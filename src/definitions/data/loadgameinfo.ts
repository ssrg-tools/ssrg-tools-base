import {
  ...
  ArenaRewardData,
  ArtistData,
  AttendanceConsecutiveData, AttendanceData,
  CardBalanceData, CardData, CardGradeBonusData, CardIntensifyData, CardInvenExpandStoreData,
  CardPackYearData, CardSellData, CardStoreData, CashPurchaseEventData, CollectEventData, CollectionAchievementData,
  CollectionPointData, ComebackAttendanceData, CommonData,
  DalcomStageMusicData, DalcomStageRewardData, DiamondStoreData,
  EventManagementData, EventMissionData, ExtraResourceData, FreePassRewardData, GameConfigData, GroupData,
  HeadphoneStoreData, HelpData, HiddenGameData, InputCharRangeData,
  IntensifyEventData, LanguageData, LeagueWeeklyInfoData,
  LeagueWeeklyRewardData, LiveThemeCardData, LiveThemeData,
  LiveThemeGifData, LiveThemeSoundData, LobbyBgData,
  LobbyBgStoreData, LocaleData, LocalePopupData, MemberData, MembershipData, MissionData, MissionDetailData, MusicData, MyRecordData,
  NewsData, NpcData, PassMissionData, PointRewardData,
  PopupHelpData, PopupStoreData, PremiumPassRewardData, PrismData, ProfileData,
  ProvidableItem, RecommendStoreData, RhythmPointStoreData,
  SelectCardData, SpecialStoreData, SpecialUserData, StarPassData,
  StarPassStoreData, ThemeData, ThemeTypeData, UpdateNoticeData, URLs, VoiceData, VoiceResourceData,
  WordFilterData, WorldRecordData,
} from './gameinfo';
...
export async function loadArenaRewardData(dir: string): Promise<ArenaRewardData[]> {
...
export async function loadAttendanceConsecutiveData(dir: string): Promise<AttendanceConsecutiveData[]> {
  return loadFileGeneric<AttendanceConsecutiveData>('AttendanceConsecutiveData', dir);
}
export async function loadAttendanceData(dir: string): Promise<AttendanceData[]> {
  return loadFileGeneric<AttendanceData>('AttendanceData', dir);
}
export async function loadCardBalanceData(dir: string): Promise<CardBalanceData[]> {
...
export async function loadCardGradeBonusData(dir: string): Promise<CardGradeBonusData[]> {
  return loadFileGeneric<CardGradeBonusData>('CardGradeBonusData', dir);
}
export async function loadCardIntensifyData(dir: string): Promise<CardIntensifyData[]> {
  return loadFileGeneric<CardIntensifyData>('CardIntensifyData', dir);
}
export async function loadCardInvenExpandStoreData(dir: string): Promise<CardInvenExpandStoreData[]> {
  return loadFileGeneric<CardInvenExpandStoreData>('CardInvenExpandStoreData', dir);
}
export async function loadCardPackYearData(dir: string): Promise<CardPackYearData[]> {
...
export async function loadCashPurchaseEventData(dir: string): Promise<CashPurchaseEventData[]> {
  return loadFileGeneric<CashPurchaseEventData>('CashPurchaseEventData', dir);
}
export async function loadCollectEventData(dir: string): Promise<CollectEventData[]> {
  return loadFileGeneric<CollectEventData>('CollectEventData', dir);
}
export async function loadCollectionAchievementData(dir: string): Promise<CollectionAchievementData[]> {
  return loadFileGeneric<CollectionAchievementData>('CollectionAchievementData', dir);
}
export async function loadCollectionPointData(dir: string): Promise<CollectionPointData[]> {
  return loadFileGeneric<CollectionPointData>('CollectionPointData', dir);
}
export async function loadComebackAttendanceData(dir: string): Promise<ComebackAttendanceData[]> {
...
export async function loadDalcomStageMusicData(dir: string): Promise<DalcomStageMusicData[]> {
  return loadFileGeneric<DalcomStageMusicData>('DalcomStageMusicData', dir);
}
export async function loadDalcomStageRewardData(dir: string): Promise<DalcomStageRewardData[]> {
  return loadFileGeneric<DalcomStageRewardData>('DalcomStageRewardData', dir);
}
export async function loadDiamondStoreData(dir: string): Promise<DiamondStoreData[]> {
  return loadFileGeneric<DiamondStoreData>('DiamondStoreData', dir);
}
export async function loadEventManagementData(dir: string): Promise<EventManagementData[]> {
  return loadFileGeneric<EventManagementData>('EventManagementData', dir);
}
export async function loadEventMissionData(dir: string): Promise<EventMissionData[]> {
  return loadFileGeneric<EventMissionData>('EventMissionData', dir);
}
export async function loadExtraResourceData(dir: string): Promise<ExtraResourceData[]> {
  return loadFileGeneric<ExtraResourceData>('ExtraResourceData', dir);
}
export async function loadFreePassRewardData(dir: string): Promise<FreePassRewardData[]> {
  return loadFileGeneric<FreePassRewardData>('FreePassRewardData', dir);
}
export async function loadGameConfigData(dir: string): Promise<GameConfigData[]> {
...
export async function loadHeadphoneStoreData(dir: string): Promise<HeadphoneStoreData[]> {
...
export async function loadHiddenGameData(dir: string): Promise<HiddenGameData[]> {
  return loadFileGeneric<HiddenGameData>('HiddenGameData', dir);
}
export async function loadInputCharRangeData(dir: string): Promise<InputCharRangeData[]> {
  return loadFileGeneric<InputCharRangeData>('InputCharRangeData', dir);
}
export async function loadIntensifyEventData(dir: string): Promise<IntensifyEventData[]> {
...
export async function loadLeagueWeeklyInfoData(dir: string): Promise<LeagueWeeklyInfoData[]> {
  return loadFileGeneric<LeagueWeeklyInfoData>('LeagueWeeklyInfoData', dir);
}
export async function loadLeagueWeeklyRewardData(dir: string): Promise<LeagueWeeklyRewardData[]> {
  return loadFileGeneric<LeagueWeeklyRewardData>('LeagueWeeklyRewardData', dir);
}
export async function loadLiveThemeCardData(dir: string): Promise<LiveThemeCardData[]> {
...
export async function loadLiveThemeGifData(dir: string): Promise<LiveThemeGifData[]> {
  return loadFileGeneric<LiveThemeGifData>('LiveThemeGifData', dir);
}
export async function loadLiveThemeSoundData(dir: string): Promise<LiveThemeSoundData[]> {
...
export async function loadLobbyBgStoreData(dir: string): Promise<LobbyBgStoreData[]> {
...
export async function loadLocalePopupData(dir: string): Promise<LocalePopupData[]> {
...
export async function loadMembershipData(dir: string): Promise<MembershipData[]> {
...
export async function loadMissionDetailData(dir: string): Promise<MissionDetailData[]> {
...
export async function loadPassMissionData(dir: string): Promise<PassMissionData[]> {
  return loadFileGeneric<PassMissionData>('PassMissionData', dir);
}
export async function loadPointRewardData(dir: string): Promise<PointRewardData[]> {
...
export async function loadPopupStoreData(dir: string): Promise<PopupStoreData[]> {
  return loadFileGeneric<PopupStoreData>('PopupStoreData', dir);
}
export async function loadPremiumPassRewardData(dir: string): Promise<PremiumPassRewardData[]> {
...
export async function loadProvidableItem(dir: string): Promise<ProvidableItem[]> {
  return loadFileGeneric<ProvidableItem>('ProvidableItem', dir);
}
export async function loadRecommendStoreData(dir: string): Promise<RecommendStoreData[]> {
  return loadFileGeneric<RecommendStoreData>('RecommendStoreData', dir);
}
export async function loadRhythmPointStoreData(dir: string): Promise<RhythmPointStoreData[]> {
  return loadFileGeneric<RhythmPointStoreData>('RhythmPointStoreData', dir);
}
export async function loadSelectCardData(dir: string): Promise<SelectCardData[]> {
  return loadFileGeneric<SelectCardData>('SelectCardData', dir);
}
export async function loadSpecialStoreData(dir: string): Promise<SpecialStoreData[]> {
  return loadFileGeneric<SpecialStoreData>('SpecialStoreData', dir);
}
export async function loadSpecialUserData(dir: string): Promise<SpecialUserData[]> {
...
export async function loadStarPassStoreData(dir: string): Promise<StarPassStoreData[]> {
...
export async function loadUpdateNoticeData(dir: string): Promise<UpdateNoticeData[]> {
...
export async function loadVoiceResourceData(dir: string): Promise<VoiceResourceData[]> {
  return loadFileGeneric<VoiceResourceData>('VoiceResourceData', dir);
}
export async function loadWordFilterData(dir: string): Promise<WordFilterData[]> {
  return loadFileGeneric<WordFilterData>('WordFilterData', dir);
}
export async function loadWorldRecordData(dir: string): Promise<WorldRecordData[]> {
